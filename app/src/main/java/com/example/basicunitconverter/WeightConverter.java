...
public class WeightConverter extends Converter {
    ...
    protected void createConversionSets() {
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.POUND, UnitTypes.Unit.KILOGRAM), amt -> {return amt * 0.453592;});
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.OUNCE, UnitTypes.Unit.GRAM), amt -> {return amt * 28.3495;});
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.TON, UnitTypes.Unit.GRAM), amt -> {return amt * 907185;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.TON, UnitTypes.Unit.KILOGRAM), amt -> {return amt * 907.185;});

        _conversionSets.put(new ConversionSet(UnitTypes.Unit.GRAM, UnitTypes.Unit.OUNCE), amt -> {return amt * 28.35;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.GRAM, UnitTypes.Unit.TON), amt -> {return amt / 907185;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.GRAM, UnitTypes.Unit.POUND), amt -> {return amt / 453.6;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.GRAM, UnitTypes.Unit.KILOGRAM), amt -> {return amt / 907.185;});
