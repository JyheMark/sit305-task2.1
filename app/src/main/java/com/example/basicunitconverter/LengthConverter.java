...
public class LengthConverter extends Converter {
    ...
    protected void createConversionSets() {
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.MILE, UnitTypes.Unit.CENTIMETRE),amt -> {return amt * 160900;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.MILE, UnitTypes.Unit.METRE),amt -> {return amt * 1609;});
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.MILE, UnitTypes.Unit.KILOMETRE),amt -> {return amt * 1.609;});
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.CENTIMETRE, UnitTypes.Unit.MILE),amt -> {return amt / 160900;});
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.METRE, UnitTypes.Unit.MILE),amt -> {return amt / 1609;});
        ...
        _conversionSets.put(new ConversionSet(UnitTypes.Unit.KILOMETRE, UnitTypes.Unit.MILE),amt -> {return amt / 1.609;});
